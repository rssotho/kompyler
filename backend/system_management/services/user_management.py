...
class UserManagementServices:
    ...
    def view_user(self):
        ...
        if self.request.user.role.role in [constant.SYSTEM_ADMIN, constant.HOSPITAL_ADMIN]:
        ...
        try:
            ...
            model_serializer: GetUserModelSerializer = GetUserModelSerializer(
                user,
                many = False
            )
